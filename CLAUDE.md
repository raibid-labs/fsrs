# Claude Code Configuration - FSRS (F# Script Runtime System)
...
**FSRS** is a Mini-F# dialect with an embeddable Rust bytecode VM designed to replace Lua-style scripting. Key features:
...
- `/rust/crates/fsrs-*/src` - Rust source code
- `/tests` - Test files
- `/docs` - Documentation
...
[Parallel Agent Execution]:
  ...
  Task("Examples", "Create example .fsrs scripts for testing", "backend-architect")

  // Batch ALL todos
  TodoWrite { todos: [...10 todos for current milestone...] }

  // Batch file operations (if doing yourself)
  Write "rust/crates/fsrs-frontend/src/lexer.rs"
  Write "rust/crates/fsrs-vm/src/value.rs"
...
- **CLAUDE_CODE_NOTES.md**: Detailed implementation tasks
- **RESEARCH_NOTES.md**: VM and embedding research
...
3. **Follow raibid-labs patterns** - Consistency across projects
